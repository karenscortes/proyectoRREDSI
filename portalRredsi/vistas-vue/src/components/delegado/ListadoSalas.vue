<template>
    <div class="container mt-5">
        ...
        <div class="teachers my-4 ">
            <div class="row">
                <CardSalas v-for="(sala, index) in salas" :key="index" :numeroSala="sala.numeroSala"
    ...
    data() {
        return {
            salas: [
                {
                    numeroSala: "201",
                    nombreDelegado: "Sebastian Alberto",
                    areaConocimiento: "Ciencias Sociales"
                },
                {
                    numeroSala: "202",
                    nombreDelegado: "Laura Motato",
                    areaConocimiento: "Sistemas"
                },
                {
                    numeroSala: "203",
                    nombreDelegado: "Valeria Carvajal",
                    areaConocimiento: "Biología"
                },
                {
                    numeroSala: "101",
                    nombreDelegado: "Miguel Alzate",
                    areaConocimiento: "Química"
                },
                {
                    numeroSala: "102",
                    nombreDelegado: "Nicolas Tapasco",
                    areaConocimiento: "Matemáticas"
                },
                {
                    numeroSala: "103",
                    nombreDelegado: "Emmanuel Botero",
                    areaConocimiento: "Ambiental"
                }
            ]
        }
    }
