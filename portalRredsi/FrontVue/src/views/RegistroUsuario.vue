<template>
    <div class="super_container">
        ...
        <div class="container mt-5">
            <h2 class="text-center text-teal text-black">Formulario de Registro</h2>
            <form @submit.prevent="handleSubmit">
                <div class="form-row mt-5">
                    <div class="form-group col-md-6">
                        <label for="tipoDocumento" class="text-black">Tipo de Documento:</label>
                        <select v-model="form.tipoDocumento" id="tipoDocumento" class="form-control">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" v-model="form.numeroDocumento" class="form-control" id="numeroDocumento">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="nombres" class="text-black">Nombres:</label>
                        <input type="text" v-model="form.nombres" class="form-control" id="nombres">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" v-model="form.correo" class="form-control" id="correo">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="telefono" class="text-black">Teléfono:</label>
                        <input type="text" v-model="form.telefono" class="form-control" id="telefono">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="contrasena" class="text-black">Contraseña:</label>
                        <input type="password" v-model="form.contrasena" class="form-control" id="contrasena">
                    </div>
...
export default {
    ...
    setup(props) {
        ...
        if (props.rol === "Administrador") {
            ...
            Object.assign(state, {
                left_tabs: [
                    { nombre: "Inicio", ruta: "#" },
                    { nombre: "Perfil", ruta: "#" },
                    { nombre: "Certificados", ruta: "#" },
                    { nombre: "Instituciones", ruta: "#" },
                ],
                mid_tabs: [
                    {
                        nombre: "Eventos",
                        opciones: [
                            { nombre: "Ponencias", ruta: "#" },
                            { nombre: "Salas", ruta: "#" },
                            { nombre: "Convocatoria", ruta: "#" },
                        ],
                    },
        ...
        const handleLogin = async () => {
            ...
            const { success, message, user: loggedInUser } = await authStore.login(email.value, password.value);
            ...
            if (!success) {
                ...
                } else if (user.value.role === "Delegado") {
                    router.push({ name: "DashboardDelegado" });
                } else {
        ...
        // Define las propiedades reactivas para el formulario de registro
        const form = reactive({
            tipoDocumento: "",
            numeroDocumento: "",
            nombres: "",
