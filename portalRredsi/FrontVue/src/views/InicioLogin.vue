                                ...
                                <li class="main_nav_item" v-for="(tab, index) in mid_tabs" :key="`mid-${index}`">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu text-center">
                                            <a v-for="(opcion, opcionIndex) in tab.opciones"
                                                :key="`option-${opcionIndex}`" :href="opcion.ruta">
                                                {{ opcion.nombre }}
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="hero_slider_container">
                <div class="hero_slider owl-carousel">
                    ...
                    <div class="hero_slide">
                        <div class="hero_slide_background" style="
            ...
            <div class="hero_boxes_inner">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 hero_box_col">
                            <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                                ...
                                <div class="hero_box_content">
                                    ...
                                    <a href="https://rredsi.com.co/xiv-encuentro-departamental-de-semilleros-de-investigacion-de-risaralda/"
                                        class="hero_box_link">ver más</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 hero_box_col">
                            <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                                <img src="../plantilla/images/earth-globe.svg" class="svg" alt="" />
                                <div class="hero_box_content">
                                    <h2 class="hero_box_title">RREDSI</h2>
                                    <a href="https://rredsi.com.co/" class="hero_box_link">ver más</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="row d-flex flex-row align-items-end">
                                ...
                                <div class="col-lg-6 order-lg-2 order-3">
                                    <div class="event_content">
                                        <div class="event_name">
                                            <a class="trans_200" href="#">Primera publicación de resultados</a>
                                        </div>
                                        <div class="event_location">Portal rredsi</div>
                                        <p>
                                            In aliquam, augue a gravida rutrum, ante nisl fermentum
                    ...
                    <div class="row event_item">
                        <div class="col">
                            <div class="row d-flex flex-row align-items-end">
                                ...
                                <div class="col-lg-4 order-lg-3 order-1">
                                    <div class="event_image">
                                        <img src="../assets/img/event_3.jpg" alt="https://unsplash.com/@juanmramosjr" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="row d-flex flex-row align-items-end">
                                ...
                                <div class="col-lg-6 order-lg-2 order-3">
                                    <div class="event_content">
                                        <div class="event_name">
                                            <a class="trans_200" href="#">Segunda publicación de resultados</a>
                                        </div>
                                        <div class="event_location">Portal rredsi</div>
                                        <p>
                                            In aliquam, augue a gravida rutrum, ante nisl fermentum
                                ...
                                <div class="col-lg-4 order-lg-3 order-1">
                                    <div class="event_image">
                                        <img src="../plantilla/images/event_2.jpg"
                                            alt="https://unsplash.com/@claybanks1989" />
                                    </div>
                                </div>
                            </div>
    ...
    setup(props) {
        ...
        if (props.rol === "Administrador") {
            ...
            Object.assign(state, {
                ...
                mid_tabs: [
                    {
                        nombre: "Informacion delegados",
                        ruta: "/lista-delegados-superadmin",
                    },
                ],
                tab_name: "",
                visibilidadLogin: "d-none",
