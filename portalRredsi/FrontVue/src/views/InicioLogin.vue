<template>
  <div class="super_container">
    ...
    <header class="header d-flex flex-row">
      <div
        class="header_content with_button d-flex flex-row align-items-center justify-content-start"
      >
        <div class="logo_container">
          <div class="logo">
            <img
              class="img-fluid"
              src="../assets/img/logoRredsi.png"
              alt="Logo"
            />
            <span>RREDSI</span>
          </div>
              ...
              >
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu text-center">
                    <a
                      v-for="(opcion, opcionIndex) in tab.opciones"
                      :key="`option-${opcionIndex}`"
                      :href="opcion.ruta"
                    >
                      {{ opcion.nombre }}
                    </a>
