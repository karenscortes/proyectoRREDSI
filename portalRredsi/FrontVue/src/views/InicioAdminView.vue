        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 order-2 order-lg-1">
              ...
              <div class="become_button text-center mt-4">
                <a href="#" class="btn btn-warning text-dark">Explorar</a>
              </div>
            </div>

            <!-- Imagen -->
            <div class="col-lg-6 order-1 order-lg-2">
              <div class="become_image text-center">
                <img src="../assets/img/become.jpg" alt="Imagen de bienvenida" class="img-fluid rounded">
              </div>
            </div>
          </div>
        </div>
