...
export default defineComponent({
    setup(_,{emit}) {
        ...
        if (user?.id_rol === 3) {
            ...
            Object.assign(state, {
                left_tabs: [{nombre: "Inicio", ruta: "InicioSuperAdminView" }, {nombre: "Editar perfil", ruta: "EditarPerfilSuperAdmin" },{nombre: "Gestionar Administradores", ruta: "ListaAdministradores" }],
                visibilidad: "d-none",
            });
        }
